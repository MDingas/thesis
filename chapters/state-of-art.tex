...
\qquad
\subfloat[Gnutella file query mechanism that utilizes caching]{\includegraphics[width=5cm]{img/can-lookup.png} }%
...
\end{figure}
    ...
    Figure \ref{fig:request-routing} displays how, conceptually, the request routing functionality of CDNs.
...
\subsubsection{Multi-Domain orchestration}
    ...
    \begin{figure}[!t]
    \centering
    \includegraphics[scale=0.60]{network-connectivity-globe.png}
    \caption{Conceptual representation of ISP diversity on the Internet \todo{cite}}
